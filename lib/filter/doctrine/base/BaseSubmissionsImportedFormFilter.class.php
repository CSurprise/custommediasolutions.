...
/**
 * SubmissionsImported filter form base class.
 *
 * @package    models
 * @subpackage filter
 ...
 */
abstract class BaseSubmissionsImportedFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('submissions_imported_filters[%s]');
