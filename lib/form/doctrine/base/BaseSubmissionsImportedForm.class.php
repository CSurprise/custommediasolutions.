...
/**
 * SubmissionsImported form base class.
 *
 * @method SubmissionsImported getObject() Returns the current form's model object
 *
 * @package    models
 * @subpackage form
 ...
 */
abstract class BaseSubmissionsImportedForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('submissions_imported[%s]');
